...
$payload = ['deviceId' => $deviceId, 'users' => [['userId' => 'VP_LAST_CHANCE', 'userName' => 'LAST TEST', 'userType' => 0]]];
$body = json_encode($payload);

$timestamp = (string)round(microtime(true) * 1000);
$nonce = bin2hex(random_bytes(16));

// Try signing the SAME way as getAccessToken (No body in factor!)
$factor = $appId . $timestamp . $nonce . "POST";
...
echo "Testing Session-Only Sign...\n";
$ch = curl_init($url);
