...
if (!isset($pdo)) {
    die("Error: PDO database variable not found in includes/db.php");
}
...
// Force V2 internally for testing
$resV2 = DahuaHelper::getPersonDetail($deviceId, $personId, $pdo); 
