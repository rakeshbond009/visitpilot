            ...
            <div class="col-lg-11">
                <div class="card glass-card border-0 rounded-5 shadow-2xl overflow-hidden">
                    <div class="card-header bg-transparent border-0 pt-5 pb-4 text-center">
                        ...
                        <p class="text-muted fs-5 mt-2">Find visitors, analyze trends, or ask **VisitPilot AI** for insights.</p>
                    </div>

                    <div class="card-body px-4 px-lg-5 pb-5">
                        <form method="GET" class="mb-5" id="searchForm">
                            <div class="input-wrapper-lg shadow-2xl rounded-pill glass-input-group p-3 d-flex align-items-center flex-wrap flex-md-nowrap gap-2">
                                <div class="d-flex align-items-center flex-grow-1 w-100 ps-2">
                                    <button type="button" id="searchMicBtn" class="btn btn-icon-round mic-btn-xl me-2" title="Voice Search">
                                        <i class="bi bi-mic-fill"></i>
                                    </button>
                                    <input type="text" name="q" id="searchInput" class="form-control border-0 bg-transparent px-3 fs-4"
                                ...
                                <div class="d-flex gap-2 w-100 w-md-auto pe-md-2 mt-3 mt-md-0">
                                    <button type="submit" class="btn btn-primary-premium rounded-pill px-4 py-2 flex-grow-1 flex-md-grow-0">
                                        <i class="bi bi-search me-1"></i> Search
                                    </button>
                                    <?php if ($search_term): ?>
                                        <a href="search.php" class="btn btn-outline-secondary rounded-pill px-4 py-2 flex-grow-1 flex-md-grow-0 d-flex align-items-center justify-content-center">
                                            <i class="bi bi-x-lg me-1"></i> Clear
                                        </a>
                                    <?php
endif; ?>
                                    <button type="button" id="aiSearchBtn" class="btn btn-ai-premium rounded-pill px-4 py-2 flex-grow-1 flex-md-grow-0">
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    <?php foreach ($results as $visit): ?>
                                        <tr onclick="viewVisitDetails(<?php echo $visit['id']; ?>)" style="cursor: pointer;">
                                            <td>
...
<style>
    ...
    .search-page-wrapper {
        ...
        position: relative;
        margin-top: -24px; /* Offset the header container padding */
    }
    ...
    .btn-primary-premium:hover, .btn-ai-premium:hover {
    ...
    .timeline-marker { position: absolute; left: 12px; top: 0; width: 18px; height: 18px; border-radius: 50%; background: #fff; border: 3px solid #0d6efd; z-index: 1; }
    .timeline-item.success .timeline-marker { border-color: #198754; }
    .timeline-item.warning .timeline-marker { border-color: #ffc107; }
    .timeline-item.danger .timeline-marker { border-color: #dc3545; }
