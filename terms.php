...
<head>
    ...
    <title>Terms & Conditions - <?php echo htmlspecialchars($company_name); ?></title>
    <!-- Fonts -->
...
<body>
    ...
    <div class="container">
        <div class="content-card">
            ...
            <p>Welcome to <?php echo htmlspecialchars($company_name); ?>. By accessing or using our Visitor Management
                System, you agree to be bound by
                these Terms of Service and our Privacy Policy.</p>

            <h2>2. License to Use</h2>
            <p>We grant you a limited, non-exclusive, non-transferable license to use our software for your
                organization's internal visitor management operations. You agree not to misuse the services or help
                anyone else do so.</p>
            ...
            <p>You agree to provide accurate and complete information when registering visitors or setting up host
                profiles. We are not liable for any issues arising from incorrect data entry.</p>

            <h2>5. Service Availability</h2>
            <p>We strive to ensure 99.9% uptime, but we do not guarantee that the service will be uninterrupted or
                error-free. We reserve the right to modify or discontinue features at any time.</p>

            <h2>6. Limitation of Liability</h2>
            <p><?php echo htmlspecialchars($company_name); ?> shall not be liable for any indirect, incidental, special,
