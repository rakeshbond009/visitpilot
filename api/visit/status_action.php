...
try {
    if ($action === 'approve') {
        ...
        // Get visitor details for response and background tasks
        ...
        sendBackgroundResponse('success', 'Visit Approved', $responseData);
        ...
        if ($visit) {
            ...
            try {
                ...
                if (!empty($raw_settings['dahua_app_id']) && !empty($raw_settings['dahua_app_secret'])) {
                    ...
                    $deviceSnsList = array_map('trim', explode(',', $raw_settings['dahua_device_sns']));
                ...
                error_log("Approval Dahua Error: " . $e->getMessage());
            }
        }
        ...
        sendBackgroundResponse('success', 'Invitation has been cancelled and visitor notified.');
        ...
        sendBackgroundResponse('success', 'Visit Rejected', $responseData);
