...
<head>
    ...
    <title>Admin Dashboard - CodePilotx VMS</title>
    <script>
    ...
    <style>
        ...
        @media (max-width: 991.98px) {
            .navbar-collapse {
                background: #212529 !important; /* Solid Dark Background */
                padding: 20px;
        ...
        <div class="container-fluid p-0 h-100">
            ...
            <div class="collapse navbar-collapse" id="vmsNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link <?php echo($current_page == 'dashboard.php' && strpos($_SERVER['PHP_SELF'], '/admin/') !== false) ? 'active' : ''; ?>"
                ...
                <div class="d-flex align-items-center">
                    <div class="text-white me-3 d-none d-md-block">
                        <span class="live-indicator"></span><small>
                            <?php echo $pulse_text; ?>
                        </small>
                    </div>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow">
                            <li><a class="dropdown-item" href="change_password.php"><i class="bi bi-key me-2"></i>Change
                                    Password</a></li>
                            <li>
