...
CREATE TABLE IF NOT EXISTS `visits` (
  ...
  `gate_registered_at` datetime DEFAULT NULL,
  ...
  KEY `dahua_person_id` (`dahua_person_id`),
...
CREATE TABLE IF NOT EXISTS machine_users (
    ...
    department VARCHAR(100) DEFAULT '1-Default',
    schedule_mode VARCHAR(100) DEFAULT 'Department Schedule',
    permission_level VARCHAR(50) DEFAULT 'User',
    user_type VARCHAR(50) DEFAULT 'General User',
    times_used VARCHAR(100) DEFAULT 'Unlimited',
    general_plan VARCHAR(100) DEFAULT '255-Default',
    holiday_plan VARCHAR(100) DEFAULT '255-Default',
    photo_path VARCHAR(255) DEFAULT NULL,
